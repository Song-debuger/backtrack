...
public class Question_2 {
    ...
    public char[] solve(int n, char[] str) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            result[i] = (char) (bestx[i] + 'A' - 1);  //将数字转化为字母
        }
        return result;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(q.solve(1, a));
        System.out.println(q.solve(11700519, b));
        System.out.println(q.solve(3072997, c));
        System.out.println(q.solve(1234567, d));
    }
}
